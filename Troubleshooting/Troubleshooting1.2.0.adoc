...
| Breakpoints | Breakpoints on comment lines are skipped without any indication | Avoid breakpoints on comment lines

| Breakpoints | Breakpoints for deleted Sample are cached and ignored for debugging | Remove all breakpoints
