...
Note: while you would define the axes manually in standard CSS Flexbox, the directions of axes are predefined for the elements in the SICK App Designer UI-Builder.
...
To directly import this example into SICK App Designer, you can either copy the following html-code into the code view of the UI-Builder or download the app which is linked further down in this tutorial:
...
You can also download the whole sample and import it into SICK App Designer:
